        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Ruta A: Registrar Iglesia (Pastor)
              CustomCard(
                onTap: () {
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Para Pastores y Administradores. Genera un código único para tu congregación.',
                            style: TextStyle(
                              fontSize: 13,
                              color: isDark ? Colors.grey[400] : Colors.grey[600],
                            ),
              ...
              // Ruta B: Unirme a mi Iglesia (Miembro)
              CustomCard(
                onTap: () {
                  Navigator.of(context).push(
                    MaterialPageRoute(
              ...
              // Botón de Iniciar Sesión / Cuentas Demo
              AppButton(
                text: 'Iniciar Sesión (Cuentas Demo)',
                onPressed: () {
                  Navigator.of(context).push(
                    MaterialPageRoute(
