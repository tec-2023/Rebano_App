...
class MockTreasuryRepository implements TreasuryRepository {
  final List<FinancialTransaction> _transactions = [
    ...
    FinancialTransaction(
      ...
      category: 'Servicio de Electricidad (CFE)',
      amount: 2840.50,
      date: DateTime.now().subtract(const Duration(days: 3)),
      donorOrRecipient: 'Comisión Federal de Electricidad',
      description: 'Pago de recibo bimestral de energía del santuario principal.',
      hasReceipt: true,
      registeredBy: 'Carlos Mendoza (Tesorero)',
    ),
    FinancialTransaction(
